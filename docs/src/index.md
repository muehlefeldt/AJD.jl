...
Below the main function of the AJD.jl package is introduced. For the entire documentation, including non exported functions, of the package refer to the [detailed docs page](./detailed-docs.md).
