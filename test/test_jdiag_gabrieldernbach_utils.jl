...
using LinearAlgebra
using AJD: isstrictly_diagonally_dominant, get_offdiag_elements, get_diag_elements,frobenius_offdiag_normation, sort_offdiag_elements, addrandomnoise,addrandomnoise!
